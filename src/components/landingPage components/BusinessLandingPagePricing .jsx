...
const BusinessLandingPagePricing = () => {
  return (
    <>
      <section className="max-w-[1480px] relative rounded-3xl mb-24 flex flex-col items-center mt-10 mb-10 z-10">
        ...
        <div className="mt-5 mb-5 flex justify-between gap-10">
          {/* Fisrt Card */}
          <div className="sm:w-64 p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-800 hover:shadow-BusinessshadowCardPricing">
            <p className="mb-4 text-xl font-medium text-new_red dark:text-gray-50">
              Entreprise
            </p>
            ...
            <button
              type="button"
              className="py-2 px-4 bg-new_red hover:bg-new_navy_blue focus:ring-new_red focus:ring-offset-new_navy_blue text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:bg-new_navy_blue rounded-lg"
            >
              Choose plan
            </button>
          </div>
      ...
      <div className="absolute w-full bottom-96 z-0">
...
export default BusinessLandingPagePricing;
