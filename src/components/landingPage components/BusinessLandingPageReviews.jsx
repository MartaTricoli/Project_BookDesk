import BusinessBgGradientSx from "../shared/BusisnessBgGradientSx";

const BusinessLandingPageReviews = () => {
  return (
    <>
      <section
        id="testimonies"
            ...
            <li>
              <div className="text-sm leading-6">
                <div className="relative group">
                  <div className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-new_red to-new_red blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
                  <a
      ...
      <BusinessBgGradientSx />
    </>
  );
};

export default BusinessLandingPageReviews;
