export const PostCard = () => {
    return(
        <>
            <div className="bg-white p-8 rounded-lg shadow-md max-w-md m-4">
                ...
                <div className="flex items-center justify-between text-gray-500">
			        <div className="flex items-center space-x-2">
                        <button className="flex justify-center items-center gap-2 px-2 hover:bg-new_dark_blue hover:text-white rounded-full p-1">
