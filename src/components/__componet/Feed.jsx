    ...
    <>
      <div className="mt-20">
        <div className="flex pl-44 pt-4 pb-12 justify-center items-center">
          <h3 className="text-center text-4xl font-bold py-4 text-new_navy_blue w-[500px] flex-nowrap mr-8">
            Tutte le novità della comunity{" "}
            <span className="text-new_dark_blue">BookDesk</span>
          </h3>
          <img
            className="w-[200px]"
