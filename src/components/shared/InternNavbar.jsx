...
import SearchBar from "../ShopComponent/SearchBar";
...
const InternNavbar = () => {
  ...
  return (
    <>
      <nav className="h-20 w-full px-8 flex items-center justify-between items-center text-white mb-24 bg-new_pastel_blue dark:bg-new_dark_blue top-0 fixed gap-20 z-[999]">
        {/* logo */}
