...
const BookSearchEMilio = () => {
    ...
    const handleSearchbook = async (event) => {
        ...
        if (memory.current[url]) {
            setbookData(memory.current[url]);
                    ...
                    <div className="flex flex-row flex-wrap justify-between ">
                        {
                            searchLoading ? (
                                ...
                                (
                                    bookData?.docs && bookData.docs.length > 0 && bookData.docs.map((book, index) => (
                                            ...
                                            <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 shadow-shadowCardShop hover:shadow-shadowCardShop1">
                                                <a href="#">
                                                    ...
                                                    <div className="px-4 py-3 w-72">
                                                        <span className="text-new_dark_blue mr-3 uppercase text-xs">{book.author_name}</span>
                                                        <p className="text-lg font-bold text-new_navy_blue truncate block capitalize">{book.title}</p>
                                                        <span className="text-new_dark_blue mr-3 uppercase text-xs">first publish: {book.first_publish_year}</span>
                                                        <span className="text-new_dark_blue mr-3 uppercase text-xs">Pages : {book.number_of_pages_median}</span>
                                     ...
                                     S619.162,694.432,619.162,716.897z"/>
                                                                ...
                                                                <button className="ml-4 px-2 py-2 bg-gradient-to-r from-new_light_blue to-new_dark_blue text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg">
                                            ...
                                            <button className="border-2 hover:border-new_yellow w-64 mt-4" onClick={() => handleAddToBookshelf(book)}>Add to your bookshelf</button>
                                        </div>
                                    ))
                                )
                        }
