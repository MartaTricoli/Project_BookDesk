...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="h-20 w-full py-10 px-16 flex items-center justify-between border-b-2 border-solid text-white mb-8 sm:mb-24 bg-new_pastel_blue dark:bg-new_dark_blue top-0 fixed z-[998]">
        <div className="">
          <Link to="/">
            <Logo />
          </Link>
